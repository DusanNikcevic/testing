$('document')
    .ready(function () {
        $
            .ajax({url: '/images', type: "GET", contentType: "application/json"})
        ...
        $
            .ajax({url: '/videos', type: "GET", contentType: "application/json"})
...
function login() {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, request) {
            document.cookie = request.getResponseHeader('x-auth');
